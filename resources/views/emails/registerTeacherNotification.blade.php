    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div style="margin: 30px 0;">
                ...
                <h6> Email Address : <a href="javascript:void()" > akashdutta.scriptcrown@gmail.com </a></h6>
                <h6> Password : <a href="javascript:void()" > SE~you@9062 </a></h6>
            </div>
            <p>If you have any questions, feel free to <a href="mailto:support@yourcompany.com">contact us</a>.</p>
            <p>Best regards,</p>
            <p>The Baazar Live Team</p>
            <div style="text-align:center">
                    <p><a href="{{ url('/') }}" class="btn btn-primary">Log In</a></p>
            </div>
        </div>
